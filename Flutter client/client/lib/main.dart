...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _dropdownValue = "Empty";
  List<String> _modelList = ["Empty"];
  ...
  void initializer() async {
    ...
    _dropdownValue = _modelList.first;
    var response = await http.get(Uri.parse('http://127.0.0.1:8000/'));
    setState(() {
      _modelList = json.decode(response.body).cast<String>();
      _dropdownValue = _modelList.first;
    });
    pathToAudio = '/tmp/temp.wav';
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            DropdownMenu<String>(
              initialSelection: _modelList.first,
              ...
              dropdownMenuEntries: _modelList.map<DropdownMenuEntry<String>>((String value) {
  ...
  Future<void> sendRecording() async {
    ...
    var data = json.encode({'uid': uuid.v4(), 'bytes': bytes, 'model' : _dropdownValue});
    //print(data);
